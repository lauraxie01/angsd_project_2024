...
ALIGNMENT_DIR="/athena/angsd/scratch/ljx4001/project/t1D_data/ctrl/control_alignments"
RESULT_DIR="/athena/angsd/scratch/ljx4001/project/t1D_data/ctrl/bamqc_results"
...
do
  ...
  # Run your command
    qualimap bamqc -bam "$FILE" --outdir /athena/angsd/scratch/ljx4001/project/t1D_data/ctrl/bamqc_results --outfile "${BASE_NAME}".pdf
done
